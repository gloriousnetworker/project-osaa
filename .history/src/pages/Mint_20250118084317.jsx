  ...
  const handleSubmit = (e) => {
    ...
    if (amount > 0 && recipient) {
      ...
      toast.success("Tokens successfully minted!", {
        position: "bottom-right",  // Correct position as a string
        className: "toast-success",
        bodyClassName: "toast-body",
        autoClose: 5000,
      });

      // Reset form fields after a short delay (to let the toast appear)
      setTimeout(() => {
        setAmount("");
        setRecipient("");
      }, 5000);  // Delay reset by the toast duration (5000ms)
    } else {
      // Failure
