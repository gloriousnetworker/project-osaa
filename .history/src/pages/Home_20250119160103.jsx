...
import { ClipboardIcon } from "@heroicons/react/outline"; // Import Heroicons for the clipboard icon
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-animation relative">
      ...
      <div className="z-10 text-center text-white px-6 sm:px-8 lg:px-12">
        ...
        {account && (
          <div className="absolute top-4 right-4 flex items-center bg-white text-black py-2 px-4 rounded-lg shadow-md">
