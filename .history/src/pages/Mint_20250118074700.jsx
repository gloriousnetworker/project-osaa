...
const MintTokens = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Form submitted', amount, recipient);  // Debugging line to check form values

    // Simulate minting logic (replace with actual blockchain logic)
    if (amount > 0 && recipient) {
      console.log('Minting successful');  // Debugging line to check if condition is met
      // Successful minting
      ...
      console.log('Minting failed');  // Debugging line to check if failure condition is met
      // Failure
